...
Диаграммы отражают текущую структуру приложения, модель данных и основной сценарий анализа вакансии. Редактируемый исходник sequence diagram хранится в [`docs/ats_sequence_flow.drawio`](docs/ats_sequence_flow.drawio).

### Последовательность обработки

![Последовательность анализа вакансии](docs/assets/uml_sequence.png)

### Модель данных

![ER-диаграмма](docs/assets/erd_3nf.png)

### Основные классы

![Диаграмма классов](docs/assets/class_diagram.png)
